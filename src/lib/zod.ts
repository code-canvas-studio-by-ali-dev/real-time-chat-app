...
const user_validation = z.object({
    fullname: z.string().nonempty({message: "Fullname field is required"}).min(3, {message: "Fullname must be atleast 3 characters long"}).max(20, {message: "Fullname must be atleast 20 characters long"}),
